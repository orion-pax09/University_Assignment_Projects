...
class Tic_Tac_Toe{
    ...
    Tic_Tac_Toe():N(4), symbol('X') , movecount(0){
        allocate();
    }
    Tic_Tac_Toe(char sym):N(4),symbol(sym) , movecount(0){
        allocate();
    } 
    void deallocate(){
        if (array==nullptr){
 ...
 friend ofstream& operator<<(ofstream& out, const Tic_Tac_Toe& game){
    ...
    bool setindex(){
        ...
        int cols;
        while (true){
            cout << "Enter the rows (0 to  "<<N<<"): "<<endl;
            ...
            cout << "Enter the column (0 to  "<<N<<"): "<<endl;
            if(!(cin>>cols)){
...
int main(){
    ...
    cout <<"Enter 1 to start new game 4x4"<<endl;
    cout<< "Enter 2 to load and save game"<<endl;
    do
    {
        cin>>button;
        if (button < 1 || button > 2){
            ...
            if(game.loadGame()){
                ...
                cout<<"Starting new game 4x4 instead"<<endl;
                game.play();                
            }
            cout<<"total move played: "<<game.getmoves()<<endl;
        }
